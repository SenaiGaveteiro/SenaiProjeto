...
INSERT INTO `pedido` VALUES (3,'2016-10-12',1,1,4),(4,'2016-11-05',1,1,1);
...
INSERT INTO `permissao` VALUES (1,'status','',2),(2,'empresa',NULL,2),(3,'produto',NULL,2),(4,'listarPorEmpresa','UsuarioRestController',2),(5,'listarPorEmpresa','PedidoRestController',2),(6,'pedido',NULL,1),(7,'status',NULL,1),(8,'usuario',NULL,2),(9,'listarPorEmpresa','PedidoRestController',1),(10,'listar','PedidoRestController',2);
...
INSERT INTO `usuario` VALUES (1,'080.356.318-37','oliveira.dev1997@gmail.com','oliveira','Leandro Oliveira','123.125.765-1','900150983cd24fb0d6963f7d28e17f72','M','4002-8922',1,2),(2,'999.343.565/32','anofre@teste.com','anofre','Jorge','123.543.234-09','ba8471e91cee56995e9507d80ff42103','M','(11)9-0000-1111',1,3);
...
-- Dump completed on 2016-11-12  0:04:41
