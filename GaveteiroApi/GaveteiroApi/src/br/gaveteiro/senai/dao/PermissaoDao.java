...
public class PermissaoDao {
	...
	{
		TypedQuery<Permissao> query = manager.createQuery("select p from Permissao p where p.controller = :controller and p.action = :action and p.tipoUsuario.idTipo = :id", Permissao.class);
