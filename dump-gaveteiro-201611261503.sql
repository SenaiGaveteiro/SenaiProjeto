...
INSERT INTO `mudanca_status` VALUES (1,'2016-11-26',4,2,3);
...
INSERT INTO `pedido` VALUES (3,'2016-10-12',1,1,4,'Rua Teste 123','Transportadora',19.99,34.94,54.93),(4,'2016-11-05',1,1,2,'Rua Teste 123','Transportadora',19.99,149.99,169.97);
...
INSERT INTO `permissao` VALUES (1,'status','',2),(2,'empresa',NULL,2),(3,'produto',NULL,2),(4,'listarPorEmpresa','UsuarioRestController',2),(5,'listarPorEmpresa','PedidoRestController',2),(6,'pedido',NULL,1),(7,'status',NULL,1),(8,'usuario',NULL,2),(9,'listarPorEmpresa','PedidoRestController',1),(10,'listar','PedidoRestController',2),(11,'alterarStatus','PedidoRestController',2);
...
-- Dump completed on 2016-11-26 15:03:59
